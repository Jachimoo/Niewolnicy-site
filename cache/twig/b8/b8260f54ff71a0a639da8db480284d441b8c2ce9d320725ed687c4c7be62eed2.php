...
class __TwigTemplate_74708291278c3f42482fa4e86240705301beb472b0a8cd10021aeb6ef8c84170 extends \Twig\Template
{
    ...
    public function getnav_loop($__page__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["p"]) {
                // line 4
                echo "    ";
                $context["active_page"] = ((($this->getAttribute($context["p"], "active", []) || $this->getAttribute($context["p"], "activeChild", []))) ? ("active") : ("unactive"));
                // line 5
                echo "    <li>
      <a href=\"";
                // line 6
  ...
  {% for p in page.children.visible %}
    {% set active_page = (p.active or p.activeChild) ? 'active' : 'unactive' %}
    <li>
  ...
  {% endfor %}
{% endmacro %}", "macros/macros.html.twig", "/user/themes/darkquark/templates/macros/macros.html.twig");
    }
}
